...
public:
    ...
    void gen_expr(const NodeExpr& expr) {
        struct ExprVisitor{
// i cant believe c++ is a real language
            Generator* gen;
        ...
        ExprVisitor visitor{.gen=this}; // i think its a lack in my knowledge atp
        std::visit(visitor,expr.var);
    }

    // i think i will turn towards violence
    void gen_stmt(const NodeStmt& stmt) {
        struct StmtVisitor{
            ...
            void operator()(const NodeStmtLet& stmt_let){
                ...
                gen->m_output << "\n    ;; --- let " << stmt_let.ident.value.value() << " ---\n";
